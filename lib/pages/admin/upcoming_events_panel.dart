...
class UpcomingEventsPanel extends StatefulWidget {
  const UpcomingEventsPanel({super.key});

  @override
  State<UpcomingEventsPanel> createState() => _UpcomingEventsPanelState();
}

class _UpcomingEventsPanelState extends State<UpcomingEventsPanel> {
  late final upcomingEventBloc = context.read<UpcomingEventsBloc>();
        ...
        Container(
          ...
          child: ListView(
            children: [
              Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: IconButton(
                        onPressed: () {
                          upcomingEventBloc.add(FetchUpcomingEvents());
                        },
              ...
              BlocBuilder<UpcomingEventsBloc, UpcomingEventsStates>(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              const Gap(25),
                              Text(
                                state.upcomingEvents[index].name,
                                style: TextStyle(
                              ...
                              Padding(
                                ...
                                child: Text(
                                  state.upcomingEvents[index].description
                                              .length >=
                                          45
                                      ? "${state.upcomingEvents[index].description.substring(0, 45)} ...."
                                      : state.upcomingEvents[index].description,
  ...
  Widget detailedSolutionWidget(EventVO solution) {
